...
namespace Offspring\LaravelApiKey\Console\Commands;
...
class GenerateApiKey extends Command
{
     ...
     * Error messages
     */
    const MESSAGE_ERROR_INVALID_NAME_FORMAT = 'Invalid name.  Must be a alphabetic characters and hyphens less than 255 characters long.';
